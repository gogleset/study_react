...
function App() {
  ...
  return (
    <div>
      ...
      <Routes>
        <Route path="/mystate" element={<MyState></MyState>} />
        <Route path="/daterange1" element={<DateRange1></DateRange1>} />
        <Route path="/myeffect" element={<MyEffect></MyEffect>} />
        <Route path="/myref" element={<MyRef></MyRef>} />
        <Route path="/myreducer" element={<MyReducer></MyReducer>} />
        <Route path="/daterange2" element={<DateRange2></DateRange2>} />
        {/* <Route path="/mycallback" element={<MyCallback></MyCallback>} /> */}
        <Route path="/mymemo" element={<MyMemo></MyMemo>} />
        {/* <Route path="/mywidth" element={<MyWidth></MyWidth>} /> */}
      </Routes>
    </div>
  );
}
