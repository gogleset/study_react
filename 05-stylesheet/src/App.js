...
import Styledelement from "./pages/Styledelement";
    ...
    <div>
      ...
      <nav>
        {/* NavLink 구성 
            ...
            - activeClassName : 현재 블우저가 위치하는 URL과 동일한 주소를 갖는 링크에게 active 클래스가 자동으로 적용된다.
        ...
        */}
        {/* <NavLink activeStyle={myStyle} to='/inline_css'>InlineCss</NavLink>
                ...
                <NavLink activeStyle={myStyle} to='/styled_element'>Styledelement</NavLink> */}
      ...
      <Routes>
        ...
        <Route path="/styled_element" element={<Styledelement></Styledelement>} />
      </Routes>
    </div>
  );
};
